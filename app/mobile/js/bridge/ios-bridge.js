...
export const iOSBridge = {
    ...
    setLastfmToken:(token, username) => sendMessage('setLastfmToken', [token, username]),
    getLastfmUsername:() => sendMessage('getLastfmUsername'),
    getLastfmStatus:() => sendMessage('getLastfmStatus'),
    getIapStatus:() => sendMessage('getIapStatus'),
    getIapButtons:() => sendMessage('getIapButtons'),
    iapPurchase:(code) => sendMessage('iapPurchase', [code]),
