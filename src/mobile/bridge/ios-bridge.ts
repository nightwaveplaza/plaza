...
export const iOSBridge = {
  ...
  toggleFullscreen: (): Promise<void> => sendMessage<void>('toggleFullscreen', []),
  openDrawer: (): Promise<void> => sendMessage<void>('openDrawer', []),
  onReady: (): Promise<void> => sendMessage<void>('onReady', []),
  socketReconnect: (): Promise<void> => sendMessage<void>('socketReconnect', []),
  getUserAgent: (): Promise<string> => sendMessage<string>('getUserAgent', []),
  getAppVersion: (): Promise<string> => sendMessage<string>('getAppVersion', []),
  setBackground: (background: string): Promise<void> =>
    sendMessage<void>('setBackground', [background]),
  setLanguage: (lang: string): Promise<void> => sendMessage<void>('setLanguage', [lang]),
  setThemeColor: (theme: string): Promise<void> => sendMessage<void>('setThemeColor', [theme]),
};
